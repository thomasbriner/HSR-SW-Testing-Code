...
Als Ausgangspunkt steht für jeden Studiengang ein entsprechender Branch zu Verfügung, z.B. `mas2023`. Zusätzlich hat es einen weiteren Branch mit dem Suffix `-solutions`, in welchem eine mögliche Lösung für die gemeinsam im Modul gelösten Aufgaben enthalten sind.
